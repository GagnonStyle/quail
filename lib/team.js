...
var team = [
	...
	member('jdoe', 'John', 'Doe', 'senior', 'Jdoe kinda sucks'),

  member('smgagnon', 'Spencer', 'Gagnon', 'junior', 'Spencer is the bomb!'),
  member('glarionov', 'George', 'Larionev', 'junior', '#georgeLyfe'),
  ...
  member('jamiraul', 'Jef', 'Amirault', 'junior', 'Jef liiiiiiiiiives!')
