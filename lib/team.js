...
var team = [
  ...
  member('smgagnon', 'Spencer', 'Gagnon', 'junior'),
  member('glarionov', 'George', 'Larionev', 'junior'),
  member('nrecchia', 'Neven', 'Recchia', 'junior'),
  member('nsrecchia', 'Noel', 'Recchia', 'junior'),
  member('dwhitaker', 'Dave', 'Whitaker', 'junior'),
  member('jamiraul', 'Jef', 'Amirault', 'junior')
 ...
 */
function copy(memb) {
	return member(memb.user, memb.fname, memb.lname, memb.year);
}
